...
import dataLeng from "@/libs/languaje/data-es.json";
      ...
      <section className="grid sm:grid-cols-2 gap-2 print:gap-2">
        <div className="flex flex-col sm:flex-row justify-between">
          <div>
            ...
            <div className="flex gap-2">
              <Text text={`Tel. Celular:`} styles="capitalize font-semibold" />
              <Link href="to:3813698820" target="_blank" className="text-sky-600 hover:text-sky-700 dark:hover:text-sky-500 hover:underline font-medium text-pretty print:text-stone-800">3813-698820</Link>
            </div>
